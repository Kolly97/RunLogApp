...
- **Races** (eigene Seite) — Wettkämpfe mit Endzeit, Distanz, Platzierung, manuellen Splits (km/Zeit/Pace/Ø-HF) und Notizen; erscheinen als goldene Marker in den Charts und einzeln im Wochenbericht.
...
## Änderungshistorie
Siehe [CHANGELOG.md](CHANGELOG.md) — aktuell **v0.5.0**.
